...
public class QndConsumerExample2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (KafkaClient kafkaClient = new KafkaClient(BOOTSTRAP_SERVERS)) {
            ...
            int COUNTER = 0;
            KafkaMessage msg = kafkaClient
                    .consumeMessage(GROUP_ID, CONSUME_FROM_BEGINNING, TOPIC, 100, TimeUnit.MILLISECONDS);
            while (msg != null) {
                System.out.println(msg.contentAsString());
                COUNTER++;
                msg = kafkaClient.consumeMessage(GROUP_ID, CONSUME_FROM_BEGINNING, TOPIC, 10, TimeUnit.MILLISECONDS);
            }
