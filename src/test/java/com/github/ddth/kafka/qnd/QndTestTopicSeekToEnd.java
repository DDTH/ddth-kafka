...
public class QndTestTopicSeekToEnd {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (KafkaProducer<String, byte[]> producer = KafkaHelper
            ...
            Thread producerThread = new Thread(() -> {
                while (!stopped) {
                    String value = DateFormatUtils.toString(new Date(), "yyyy-MM-dd HH:mm:ss.SSS");
            ...
            try (KafkaConsumer<String, byte[]> consumer = KafkaHelper
                ...
                for (int i = 0; i < 5; i++) {
                    ...
                    System.err.println("Seek to end [" + TOPIC + "]: " + KafkaHelper.seekToEnd(consumer, TOPIC));
